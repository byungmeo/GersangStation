...
internal static class ConfigManager {
    ...
    public static void Validation() {
         Dictionary<string, string> keyValuePairs = new Dictionary<string, string> {
            ...
            { "is_auto_update", "True" },
            { "winforms_manifest_url", "https://raw.githubusercontent.com/byungmeo/GersangStation/master/metadata/winforms-release-manifest.json" },
            { "winforms_release_manifest_url", "https://raw.githubusercontent.com/byungmeo/GersangStation/master/metadata/winforms-release-manifest.json" },
            { "winforms_announcement_manifest_url", "https://raw.githubusercontent.com/byungmeo/GersangStation/master/metadata/winforms-announcements-manifest.json" },
            { "winforms_sponsors_manifest_url", "https://raw.githubusercontent.com/byungmeo/GersangStation/master/metadata/winforms-sponsors-manifest.json" },
            { "prev_announcement", "" },
