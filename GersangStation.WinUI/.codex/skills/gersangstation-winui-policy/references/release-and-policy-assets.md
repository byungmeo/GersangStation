...
- Keep WinUI help, policy, and external license URLs in the repository-root `metadata\winui-links-manifest.json`, package that manifest into the app, and load it once at startup so missing keys can fall back to an in-app HTML error page.
