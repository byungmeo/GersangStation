...
def main():
    ...
    parser.add_argument("command", choices=("snapshot", "upload", "edit"))
    parser.add_argument("--product-id", default=os.environ.get("STORE_PRODUCT_ID"))
    parser.add_argument("--package", type=Path)
    parser.add_argument("--version")
    parser.add_argument("--changes", type=Path, help="Edit plan generated by snapshot (JSON Merge Patch)")
    ...
    if args.command == "edit" and not args.changes:
        parser.error("edit needs --changes from a snapshot")
    if args.command == "snapshot" and (args.package or args.changes or args.assets_dir):
