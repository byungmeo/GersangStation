        ...
        private void materialButton_createClient_Click(object sender, EventArgs e) {
            ...
            if (button.Equals(materialButton_createClient)) {
                ...
                MaterialTextBox textBox_second = new MaterialTextBox() {
                    ...
                    Text = ConfigManager.getConfig("directory_name_client_2")
                };
                ...
                MaterialTextBox textBox_third = new MaterialTextBox() {
                    ...
                    Text = ConfigManager.getConfig("directory_name_client_3")
                };
                ...
                button_ok.Click += (sender, e) => {
                    ...
                    ConfigManager.setConfig("directory_name_client_2", secondName);
                    ConfigManager.setConfig("directory_name_client_3", thirdName);

                    if (checkBox_apply.Checked) {
                        textBox_path_2.Text = textBox_path_1.Text + "\\..\\" + secondName;
                        textBox_path_3.Text = textBox_path_1.Text + "\\..\\" + thirdName;
                    }
                ...
                //textBox_path_test_1
                string path = ConfigManager.getConfig("client_path_test_1");
                ClientCreator.client_create(path, "Station_Test_2", "Station_Test_3");
            }
        }
    }
}
